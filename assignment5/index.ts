...
// Run a loop 10 times, adding a new incremental value to the array
...
// Use for loop to iterate through the array element

for(let i = 0; i < myArray.length; i++){
    console.log(`${i}: ${myArray[i]}`);
}

// Use for...of loop to output the value into the console from the array
